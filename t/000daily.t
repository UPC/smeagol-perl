...
{
	my $start = DateTime->new( year => 2009, month => 07, day => 01, hour => 8 , minute => 0  );
	my $end = DateTime->new( year => 2009, month => 07, day => 06, hour => 10 , minute => 0  );
	...
	my $duration = DateTime->new( year => 1970, hour => 10, minute => 0 ) - DateTime->new( year => 1970, hour => 8, minute => 0 );
