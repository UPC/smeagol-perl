...
diag("\nEvent info: ".$event_check->info." and should be ".'Test (edited)');
diag("Info edition failed") unless $event_check->info eq 'Test (edited)';

diag("\nEvent info: ".$event_check->description." and should be ".'Test event (edited)');
diag("Description edition failed") unless $event_check->description eq 'Test event (edited)';
